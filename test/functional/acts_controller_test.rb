...
class ActsControllerTest < ActionController::TestCase
  ...
  test "should create act" do
    assert_difference('Act.count') do
      post :create, act: { description: @act.description, duedate: @act.duedate, priority: @act.priority, severity: @act.severity, status: @act.status, title: @act.title }
    end
  ...
  test "should update act" do
    put :update, id: @act, act: { description: @act.description, duedate: @act.duedate, priority: @act.priority, severity: @act.severity, status: @act.status, title: @act.title }
    assert_redirected_to act_path(assigns(:act))
  end
